...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Eran Broder/MyFirstPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Eran Broder' => 'brodereran@gmail.com' }
  s.source           = { :git => 'https://github.com/Eran Broder/MyFirstPod.git', :tag => s.version.to_s }
